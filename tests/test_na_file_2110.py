"""
test_na_file_2110.py
====================

Tests for the na_file_2110.py module.
...
class NAFile2110_TestCase(unittest.TestCase):

    def setUp(self):
        self.infile = os.path.join(data_files, "2110.na")
        self.outfile = os.path.join(test_outputs, "test_2110.na")
        self.out_csv = os.path.join(test_outputs, "test_2110.csv")
        self.out_csv_annotated = os.path.join(test_outputs, "test_2110_annotated.csv")
        self.fin = nappy.openNAFile(self.infile)
        self.fin.readData()
        self.na_dict = self.fin.getNADict()        

    def test_read2110(self):
        "Tests reading FFI 2110."
        self.assertEqual(type(self.na_dict), type({1:2}))

    def test_write2110(self):
        "Tests writing FFI 2110."
    ...
    def test_writeAnnotatedCSV2110(self):
    ...
    def test_compareFiles2110(self):
    ...
    def test_compareNAToCSV2110(self):
