"""
test_na_file_1020.py
====================

Tests for the na_file_1020.py module.
...
class NAFile1020_TestCase(unittest.TestCase):

    def setUp(self):
        self.infile = os.path.join(data_files, "1020.na")
        self.outfile = os.path.join(test_outputs, "test_1020.na")
        self.out_csv = os.path.join(test_outputs, "test_1020.csv")
        self.out_csv_annotated = os.path.join(test_outputs, "test_1020_annotated.csv")
        self.fin = nappy.openNAFile(self.infile)
        self.fin.readData()
        self.na_dict = self.fin.getNADict()        

    def test_read1020(self):
        "Tests reading FFI 1020."
        self.assertEqual(type(self.na_dict), type({1:2}))

    def test_write1020(self):
        "Tests writing FFI 1020."
    ...
    def test_writeAnnotatedCSV1020(self):
    ...
    def test_compareFiles1020(self):
    ...
    def test_compareNAToCSV1020(self):
